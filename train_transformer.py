...
from model_transformer import NBAGamePredictionTransformerModel
...
def main():
    ...
    parser.add_argument(
        '--precomputed_dir',
        type=str,
        default=r'c:\Users\jeffc\Desktop\ECE 143\project\data\precomputed_features',
    ...
    parser.add_argument('--dropout', type=float, default=0.3,
                        help='Dropout rate for transformer and other layers')
    ...
    parser.add_argument('--precision', type=str, default='16-mixed',
                        help='Use mixed precision for faster training')
    ...
    parser.add_argument('--experiment_name', type=str, default='transformer_default')
